...
use Tests\TestCase;
use Thoughtco\StatamicStacheSqlite\Entries\Entry;
...
class EntryTest extends TestCase
{
    ...
    public function calling_unknown_method_throws_exception()
    {
        ...
        $this->expectExceptionMessage('Call to undefined method Thoughtco\StatamicStacheSqlite\Entries\Entry::thisFieldDoesntExist()');
